...
public boolean isInside(float x, float y, float keyWidth, float keyHeight) {  //used to determine if the mouse is inside a key.
...
public void caseNote(String n, int nP, boolean noteP) {
...
class PKey{
  ...
  public void settings() {  size(601, 221); }
